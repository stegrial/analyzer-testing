...
class ExtWebComponentsPage < PageExtension

  HERO_HEADER_IL = "//div[@id='heroHeader']/h1"
  HERO_HEADER_TA = "sencha:ext_web_components_page:hero_header"

  HERO_TEXT_IL = "//div[@id='heroText']/p"
  HERO_TEXT_TA = "sencha:ext_web_components_page:hero_text"
