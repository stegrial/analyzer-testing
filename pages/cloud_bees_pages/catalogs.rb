...
class CloudBeesCatalogs
  ...
  CREATE_NEW_CATALOG_TA = "cloud_bees:create_new_catalog"
  CREATE_NEW_CATALOG_EP = "EP:cloud_bees:create_new_catalog"

  CREATE_NEW_BUTTON_IL = ".at-row-create-new"
  CREATE_NEW_BUTTON_TA = "cloud_bees:create_new_btn"
  CREATE_NEW_BUTTON_EP = "EP:cloud_bees:create_new_btn"

  CATALOGS_NAME_FLD_IL = ".at-catalog-name-input"
  CATALOGS_NAME_FLD_TA = "cloud_bees:catalog_name"
  CATALOGS_NAME_FLD_EP = "EP:cloud_bees:catalog_name"

  PROJECT_DROPDOWN_IL = ".at-select-header-title"
  PROJECT_DROPDOWN_TA = "cloud_bees:open_project_dropdown"
  PROJECT_DROPDOWN_EP = "EP:cloud_bees:open_project_dropdown"

  DEFAULT_PROJECT_IL = "(//div[contains(@class,'at-project-select-picker-project-name')])[1]"
  DEFAULT_PROJECT_TA = "cloud_bees:select_default_proj"
  DEFAULT_PROJECT_EP = "EP:cloud_bees:select_default_proj"

  OK_IN_MODAL_BTN_IL = ".at-ok-btn"
  OK_IN_MODAL_BTN_TA = "cloud_bees:ok_in_modal_btn"
  OK_IN_MODAL_BTN_EP = "EP:cloud_bees:ok_in_modal_btn"

  CATALOGS_NAME_FORM_IL = ".at-react-form-txt-input"
  CATALOGS_NAME_FORM_TA = "cloud_bees:catalogs_name_form"
  CATALOGS_NAME_FORM_EP = "EP:cloud_bees:catalogs_name_form"

  CATALOGS_DESCRIPTION_FORM_IL = ".at-catalog-description-textarea"
  CATALOGS_DESCRIPTION_FORM_TA = "cloud_bees:catalogs_description_form"
  CATALOGS_DESCRIPTION_FORM_EP = "EP:cloud_bees:catalogs_description_form"

  ADD_ANOTHER_BTN_IL = ".at-button-add"
  ADD_ANOTHER_BTN_TA = "cloud_bees:add_another"
  ADD_ANOTHER_BTN_EP = "EP:cloud_bees:add_another"

  DEFINE_BTN_IL = ".at-catalog-save-and-define"
  DEFINE_BTN_TA = "cloud_bees:define_btn"
  DEFINE_BTN_EP = "EP:cloud_bees:define_btn"

  SELECT_BTN_LABEL_IL = ".at-select-header-title"
  SELECT_BTN_LABEL_TA = "cloud_bees:select_btn_label"
  SELECT_BTN_LABEL_EP = "EP:cloud_bees:select_btn_label"

  EXECUTE_OPTION_IL = ".at-select-option-3"
  EXECUTE_OPTION_TA = "cloud_bees:execute_option"
  EXECUTE_OPTION_EP = "EP:cloud_bees:execute_option"

  CLOUD_BEES_ICON_IL = "//div[contains(text(),'CloudBees Flow')]"
  CLOUD_BEES_ICON_TA = "cloud_bees:cloud_bees_icon"
  CLOUD_BEES_ICON_EP = "EP:cloud_bees:cloud_bees_icon"

  PROCEDURE_DEFINITION_IL = "//span[contains(text(),'Procedure')]"
  PROCEDURE_DEFINITION_TA = "cloud_bees:procedure_definition"
  PROCEDURE_DEFINITION_EP = "EP:cloud_bees:procedure_definition"

  PROCEDURE_PROJ_IL = "(//div[contains(@class, 'at-select-header-title')])[2]"
  PROCEDURE_PROJ_TA = "cloud_bees:procedure_proj"
  PROCEDURE_PROJ_EP = "EP:cloud_bees:procedure_proj"

  PROCEDURE_EC_EXAMPLE_PROJ_IL = "(//div[contains(@class, 'at-project-select-item-picker-2')])"
  PROCEDURE_EC_EXAMPLE_PROJ_TA = "cloud_bees:procedure_default_proj"
  PROCEDURE_EC_EXAMPLE_PROJ_EP = "EP:cloud_bees:procedure_default_proj"

  SELECT_PROCEDURE_IL = "(//div[contains(@class, 'at-select-header-title')])[3]"
  SELECT_PROCEDURE_TA = "cloud_bees:select_procedure_proj"
  SELECT_PROCEDURE_EP = "EP:cloud_bees:select_procedure_proj"

  SELECT_APPROVE_PROCEDURE_IL = ".at-select-option-1"
  SELECT_APPROVE_PROCEDURE_TA = "cloud_bees:approve_procedure_proj"
  SELECT_APPROVE_PROCEDURE_EP = "EP:cloud_bees:approve_procedure_proj"

  ALL_CATALOGS_IL = ".at-objects-list-popover"
  ALL_CATALOGS_TA = "cloud_bees:all_catalogs"
  ALL_CATALOGS_EP = "EP:cloud_bees:all_catalogs"

  CREATED_CATALOG_IL = "//span[contains(text(), 'test1')]"
  CREATED_CATALOG_TA = "cloud_bees:test1"
  CREATED_CATALOG_EP = "EP:cloud_bees:test1"

  CATALOG_EDITOR_IL = "//a[contains(@class, 'navigation__link')][2]"
  CATALOG_EDITOR_TA =  "cloud_bees:catalog_editor"
  CATALOG_EDITOR_EP =  "EP:cloud_bees:catalog_editor"

  CATALOG_HUMBURGER_MENU_IL = ".at-slide-menu-btn"
  CATALOG_HUMBURGER_MENU_TA = "cloud_bees:catalog_menu"
  CATALOG_HUMBURGER_MENU_EP = "EP:cloud_bees:catalog_menu"

  DELETE_CATALOG_IL = ".at-slide-menu-item-6"
  DELETE_CATALOG_TA = "cloud_bees:delete_catalog"
  DELETE_CATALOG_EP = "EP:cloud_bees:delete_catalog"

  ACCEPT_DELETE_CATALOG_IL = ".at-ok-btn"
  ACCEPT_DELETE_CATALOG_TA = "cloud_bees:accept_delete_catalog"
  ACCEPT_DELETE_CATALOG_EP = "EP:cloud_bees:accept_delete_catalog"

  CATALOGS_LIST_IL = ".at-objects-list-popover"
  CATALOGS_LIST_TA = "cloud_bees:catalog_list"
  CATALOGS_LIST_EP = "EP:cloud_bees:catalog_list"

  APPS_IN_CATALOG_LIST_IL = ".at-popover-list-element-name-applications"
  APPS_IN_CATALOG_LIST_TA = "cloud_bees:apps_in_catalog_list"
  APPS_IN_CATALOG_LIST_EP = "EP:cloud_bees:apps_in_catalog_list"

  CONTAINERS_IN_CATALOG_LIST_IL = ".at-popover-list-element-name-containers"
  CONTAINERS_IN_CATALOG_LIST_TA = "cloud_bees:conteiners_in_catalog_list"
  CONTAINERS_IN_CATALOG_LIST_EP = "EP:cloud_bees:conteiners_in_catalog_list"

  UTILITY_IN_CATALOG_LIST_IL = ".at-popover-list-element-name-utility"
  UTILITY_IN_CATALOG_LIST_TA = "cloud_bees:utility_in_catalog_list"
  UTILITY_IN_CATALOG_LIST_EP = "EP:cloud_bees:utility_in_catalog_list"
  ...
  def set_catalog_name(key = nil)
    return find(ta(CATALOGS_NAME_FLD_EP)).set('test1') if key == :ep
    return find(:css, CATALOGS_NAME_FLD_IL).set('test1') if key == :il
    find(:css, ta(CATALOGS_NAME_FLD_TA, CATALOGS_NAME_FLD_IL)).set('test1')
  end
  ...
  def set_name_in_form(key = nil)
    return find(ta(CATALOGS_NAME_FORM_EP)).set('new_name_of_catalog') if key == :ep
    return find(:css, CATALOGS_NAME_FORM_IL).set('new_name_of_catalog') if key == :il
    find(:css, ta(CATALOGS_NAME_FORM_TA, CATALOGS_NAME_FORM_IL)).set('new_name_of_catalog')
  end

  def set_name_in_form2(key = nil)
    return find(ta(CATALOGS_NAME_FORM_EP)).set('new_name_of_catalog2') if key == :ep
    return find(:css, CATALOGS_NAME_FORM_IL).set('new_name_of_catalog2') if key == :il
    find(:css, ta(CATALOGS_NAME_FORM_TA, CATALOGS_NAME_FORM_IL)).set('new_name_of_catalog2')
  end

  def set_description_in_form(key = nil)
    return find(ta(CATALOGS_DESCRIPTION_FORM_EP)).set('description') if key == :ep
    return find(:css, CATALOGS_DESCRIPTION_FORM_IL).set('description') if key == :il
    find(:css, ta(CATALOGS_DESCRIPTION_FORM_TA, CATALOGS_DESCRIPTION_FORM_IL)).set('description')
  end
