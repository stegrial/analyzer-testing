...
feature 'TrueAutomation.IO capybara example' do
  scenario 'Tumblr login and blogs adding' do
    visit 'https://www.tumblr.com/'
     ...
     # find(ta('Jul:tumblr:signup_email')).set('yourEmail@gmail.com')
     find(:xpath, "//input[@id='signup_email']").set('yourEmail@gmail.com')

     # find(:xpath, ta('Jul:tumblr:signup_password', "//input[@id='signup_password']")).set('4321test')
     # find(ta('Jul:tumblr:signup_password')).set('4321test')
     find(:xpath, "//input[@id='signup_password']").set('4321test')
     ...
     # find(ta('Jul:tumblr:signup_determine_email')).set('arapova.jul2@gmail.com')
     find(:xpath, "//input[@id='signup_determine_email']").set('arapova.jul2@gmail.com')
sleep 5
     ...
     find(:xpath, "//span[@class='signup_determine_btn active']").click

     # find(:xpath, ta('Jul:tumblr:forgot_password_link', "(//a[@class='forgot_password_link'])[1]")).click
     # find(:xpath, ta('Jul:tumblr:forgot_password_link')).click
     find(:xpath, "(//a[@class='forgot_password_link'])[1]").click

     # find(:xpath, ta('Jul:tumblr:signup_password', "//input[@id='signup_password']")).set('123456789QWERTY')
     # find(ta('Jul:tumblr:signup_password')).set('123456789QWERTY')
     find(:xpath, "//input[@id='signup_password']").set('123456789QWERTY')
     ...
     find(:xpath, "//span[@class='signup_login_btn active']").click
