...
describe 'Preconditions' do
  ...
  # Element Picker from Repository
    scenario 'Searching EP', ep: true do
      ...
      step "User click remove link" do
        check_element_path :xpath, TheTiebarCartPage::REMOVE_LINK_FROM_CART_EP, TheTiebarCartPage::REMOVE_LINK_FROM_CART_IL
        cart_page.click_remove_link_from_cart_page :ep
      end
    end
  end
end