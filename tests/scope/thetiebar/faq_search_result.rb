...
faq_search_result_page = TheTiebarFaqSearchResult.new
...
describe 'Preconditions' do
  ...
  feature 'FAQ page - search query' do
    ...
    scenario 'Recording IL', il: true do
      step "User goes to the page", settings('thetiebar')['faq_search_result_page'] do |url|
        page.visit url
      end

      step "User fill FAQ search input", 'size' do |search_query|
        faq_search_result_page.fill_faq_search_input  search_query
      end

      step "User  clicks to select search query" do
        sleep 3
        faq_search_result_page.click_size_neckties
      end

      step "User breadcrumb tiebar" do
        faq_search_result_page.click_breadcrumb_tiebar
      end
      ...
      step "User clicks search button" do
        faq_search_result_page.click_faq_search_btn
      end

      step "User clicks second query of knowledge base(clicks 'What size are your neckties?')" do
        faq_search_result_page.click_knowledge_base_neckties
      end
    ...
    scenario 'Searching IL', il: true do
      ...
      step "User fill FAQ search input", 'size' do |search_query|
        ...
        faq_search_result_page.fill_faq_search_input  :il, search_query
      end
    ...
    scenario 'Searching EP', ep: true do
      ...
      step "User clicks search button" do
        ...
        faq_search_result_page.click_faq_search_btn :ep
      end
      ...
      step "User clicks second query of knowledge base(clicks 'What size are your neckties?')" do
        ...
        faq_search_result_page.click_knowledge_base_neckties :ep
      end
