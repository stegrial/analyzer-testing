  ...
  feature 'Cloud Bees - Сhanging Run Status on Pipeline Runs page' do
    ...
    scenario 'Searching EP', ep: true do
      ...
      step "User clicks to unselect  error status" do
        ...
        check_element_path :css, CloudBeesPipelinesRuns::ERROR_RUN_STATUS_EP, CloudBeesPipelinesRuns::ERROR_RUN_STATUS_IL
        pipelines_runs.click_to_select_error_status :ep
      end
