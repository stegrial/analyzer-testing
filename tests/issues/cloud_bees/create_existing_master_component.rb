...
describe 'Preconditions' do
  ...
  feature 'AT-111 Cloud Bees - create existing master component (Create Application Component from Existing Master Component)' do
    ...
    scenario 'Recording IL', il: true do
      ...
      step "Admin select on the dropdown Default project" do
    ...
    scenario 'Search_debug IL', search_debug: true do
      step "User goes to the page", settings('cloud_bees')['login_page'] do |url|
        page.visit url
      end
