...
describe 'Preconditions' do
  ...
  feature 'AT-6, Two scenarios: Wrong element found and NOT_FOUND response (Cloud Bees - Select default project)' do
    ...
    scenario 'Searching IL, Wrong element found when need element is not present on the page', ilt: true do
      step "User goes to the page", settings('cloud_bees')['login_page'] do |url|
        page.visit url
      end
    ...
    scenario 'Searching IL, NOT_FOUND response when the element is present on the page', il: true do
      step "User goes to the page", settings('cloud_bees')['login_page'] do |url|
        page.visit url
      end
    ...
    scenario 'Searching EP, NOT_FOUND response when the element is present on the page', ep: true do
      step "User goes to the page", settings('cloud_bees')['login_page'] do |url|
        page.visit url
      end
